...
class KeywordRuleMerchantClassifier : MerchantClassifier {
    ...
    private val expenseRules: List<Pair<Regex, ExpenseCategory>> = listOf(
        Regex(
            "toda|tricycle|jeep|grab(?!food)|angkas|joyride|lrt|mrt|\\bbus\\b|taxi|padyak|habal|" +
                "ub[e]?r|move ?it|p2p|fx taxi|aircon bus|skybus|ceres|victory liner|jam liner|" +
                "tollway|toll fee|easytrip|autosweep|parking fee|gasolin|petron|shell|caltex|seaoil|jetti",
        ...
        Regex(
            "meralco|maynilad|pldt|globe(?! gcash)|smart(?! padala)|converge|water bill|electric bill|" +
        ...
        Regex(
            "philhealth|\\bsss\\b|pag-?ibig|\\bbir\\b|nbi clearance|police clearance|barangay clearance|" +
                ...
                "lto\\b|land transportation|real property tax|amilyar|government fee|gov'?t fee",
            RegexOption.IGNORE_CASE
    ...
    private val incomeRules: List<Pair<Regex, IncomeCategory>> = listOf(
        ...
        Regex(
            "freelance|sideline|upwork|fiverr|project payment|gig|consultancy fee|commission|" +
