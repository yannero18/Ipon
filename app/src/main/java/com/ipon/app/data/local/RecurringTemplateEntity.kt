 ...
 * user's device is "the single, uncompromised source of truth," which
 ...
 * this due" without re-deriving it from the transactions table (which would
 * require fuzzy-matching merchant strings -- unreliable). Format mirrors the
