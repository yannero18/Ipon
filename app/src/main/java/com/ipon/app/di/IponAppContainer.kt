...
class IponAppContainer(context: Context) {
    ...
    val budgetPlanRepository = BudgetPlanRepository(repository, envelopeRepository, recurringTemplateRepository)
...
class IponViewModelFactory(private val container: IponAppContainer) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when (modelClass) {
        ...
        InsightsViewModel::class.java -> InsightsViewModel(container.repository, container.envelopeRepository) as T
